...
#import "ExpressViewController/ExpressDeliverViewController.h"//录入快递单发货
 ...
 - (void)requestInitData
{
    ...
    [HttpManager sendHttpRequestForOrderDeliverListMerchantNo:self.merchantNo pageNo:[NSString stringWithFormat:@"%d",self.pageNo] pageSize:@"20" success:^(AFHTTPRequestOperation *operation, id responseObject) {
...
//            merSendDto.totalCount == merSendDto.memberListArr.count
