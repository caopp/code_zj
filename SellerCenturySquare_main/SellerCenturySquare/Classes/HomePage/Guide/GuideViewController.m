...
-(void)createSC{
    ...
    }else if (SCREEN_HIGHT<= 568 && SCREEN_HIGHT>480){
    ...
    guideScrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HIGHT)];
    
    guideScrollView.contentSize = CGSizeMake(SCREEN_WIDTH*5, SCREEN_HIGHT);
    ...
    for (int i = 0; i < imagesArray.count; i++) {
        ...
        UIImageView *imageView = [[UIImageView alloc]initWithFrame:CGRectMake(i*SCREEN_WIDTH, 0, SCREEN_WIDTH, SCREEN_HIGHT)];
        ...
        if (i == imagesArray.count-1) {
            ...
            enterButton.frame = CGRectMake(20, SCREEN_HIGHT-120, SCREEN_WIDTH-40, 80);
...
//            enterButton.alpha = 0.5;
    ...
    pageControl = [[UIPageControl alloc]initWithFrame:CGRectMake(20, SCREEN_HIGHT-50, SCREEN_WIDTH-40, 30)];
