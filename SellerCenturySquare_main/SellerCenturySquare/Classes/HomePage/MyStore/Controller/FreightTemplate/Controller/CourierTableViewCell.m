...
-(void)getLookFreightTemplateCellData:(CourierModel *)data
{
    ...
    //采购单
     CGSize courierSize = [self sizeWithText:[NSString stringWithFormat:@"%@",data.acceptStation] font:[UIFont systemFontOfSize:14] maxSize:CGSizeMake(self.frame.size.width - 37 - 15, MAXFLOAT)];
...
//    self.courierTimeLabel.text  = [self dateStr:[NSString stringWithFormat:@"%@",data.acceptTime]];
