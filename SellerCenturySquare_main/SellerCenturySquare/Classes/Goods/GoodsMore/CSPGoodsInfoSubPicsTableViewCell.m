...
//    url = @"http://www.sxhzwh.com/Templates/cn/images/banner1.jpg";
    ...
    [_imgView sd_setImageWithURL:url_ placeholderImage:[UIImage imageNamed:@""] completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
