...
@interface ThreePageViewController ()<UIWebViewDelegate,FourPageViewControllerDelegate>
{
    BOOL _showTabBar;//显示底部tabbar
    FourPageViewController *fourPageVC;
...
- (void)viewDidLoad {
    ...
    fourPageVC = [[FourPageViewController alloc]init];
...
-(void)didClickMembershipPrivilege
{
    ...
    fourPageVC.delegate = self;
    fourPageVC.file = self.file;
