...
- (void)drawRect:(CGRect)rect
{
    ...
    if (!_isMainLabel) {
        mainColor = [UIColor colorWithHex:0x000000 alpha:1].CGColor;
        subColor = [UIColor colorWithHex:0x999999 alpha:1].CGColor;
    } else {
        subColor = [UIColor colorWithHex:0x000000 alpha:1].CGColor;
        mainColor = [UIColor colorWithHex:0x999999 alpha:1].CGColor;
    }
