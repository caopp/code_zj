...
#import "CenterSampleShopMessageCombinedTableViewCell.h"
@interface CenterSampleShopMessageCombinedTableViewCell ()
/**
 * 商品图片
 */
...
@end
@implementation CenterSampleShopMessageCombinedTableViewCell
