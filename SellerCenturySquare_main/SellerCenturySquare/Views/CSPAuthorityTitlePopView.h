...
typedef void(^BuyTimesButtonBlock)();
...
@property (weak, nonatomic) IBOutlet CustomButton *buyTimesButton;
@property (copy, nonatomic) BuyTimesButtonBlock buyTimesButtonBlock;
