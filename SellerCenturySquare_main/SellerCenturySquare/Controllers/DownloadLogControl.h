...
// !下载完成的通知
extern NSString * const NotificationOfDownloadComplete;
...
@property (nonatomic, assign) id<DownloadLogItemDelegate> delegate;
...
@property (nonatomic, assign)id<DownloadLogControlDelegate> delegate;
