...
inline static NSString* keyForURL(NSURL* url) {
    return [NSString stringWithFormat:@"%@-%lu", [LoginDTO sharedInstance].merchantNo, (unsigned long)[[url description] hash]];
}
