...
-(void)loadMessage:(ECMessage *)message{
   ...
   // titleLab.text = [NSString stringWithFormat:@"[%@] %@ ￥%@ 采购单号:%@",[[DeviceDBHelper sharedInstance] typeWith:[orderState intValue]],[[DeviceDBHelper sharedInstance] statusWith:[orderStatus intValue] ],orderPrice,orderNo];
