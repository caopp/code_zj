...
#define kWidthBtn [UIScreen mainScreen].bounds.size.width/3
...
//        self.bounds = CGRectMake(0, 0, 320, 216);
        ...
        //
        UIView *line1 = [[UIView alloc] initWithFrame:CGRectMake(kWidthBtn-1, 0, kLineWidth, 216)];
        line1.backgroundColor = color;
        [self addSubview:line1];
        
        UIView *line2 = [[UIView alloc] initWithFrame:CGRectMake(kWidthBtn*2-1, 0, kLineWidth, 216)];
