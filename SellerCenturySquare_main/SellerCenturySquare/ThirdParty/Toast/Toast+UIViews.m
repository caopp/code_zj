...
// image view size
static const CGFloat CSToastImageViewWidth      = 28.0;
...
//            return CGPointMake(self.bounds.size.width / 2, (self.bounds.size.height/2 - (toast.frame.size.height / 2))+CSToastVerticalPadding+CSToastVerticalPadding);
            return CGPointMake(self.bounds.size.width / 2, (self.bounds.size.height  - toast.frame.size.height -180));
//568
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if(image != nil) {
        ...
        imageView.frame = CGRectMake(35+30+6, CSToastVerticalPadding+8, CSToastImageViewWidth, CSToastImageViewHeight);
    }
    ...
    if (title != nil) {
        ...
        titleLabel.frame = CGRectMake(40, 80, expectedSizeTitle.width, expectedSizeTitle.height);
    }
    ...
    wrapperView.frame = CGRectMake(0.0, 0.0, 170, 100);
    
    if(titleLabel != nil) {
        titleLabel.frame = CGRectMake(20, titleTop, titleWidth, titleHeight);
        [wrapperView addSubview:titleLabel];
    }
    
    if(messageLabel != nil) {
        messageLabel.frame = CGRectMake(5+30 , 55, 100, 25);
