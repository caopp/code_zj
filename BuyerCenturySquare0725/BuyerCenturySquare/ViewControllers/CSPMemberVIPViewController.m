...
- (void)viewDidLoad {
    ...
    self.MemberlevelTableView = [[UITableView alloc]init];
//    self.MemberlevelTableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 30, self.view.frame.size.width, self.view.frame.size.height - 30) style:UITableViewStylePlain];
    ...
    self.onlineServiceTableView = [[UITableView alloc]init];
//    self.onlineServiceTableView = [[UITableView alloc]initWithFrame:self.MemberlevelTableView.frame style:UITableViewStylePlain];
    ...
    self.offlineServiceTableView = [[UITableView alloc]init];
//    self.offlineServiceTableView = [[UITableView alloc]initWithFrame:self.MemberlevelTableView.frame style:UITableViewStylePlain];
    ...
    //线顶头
    if ([self.MemberlevelTableView respondsToSelector:@selector(setSeparatorInset:)])
    {
        [self.MemberlevelTableView setSeparatorInset:UIEdgeInsetsZero];
    }
    if ([self.MemberlevelTableView respondsToSelector:@selector(setLayoutMargins:)])
    {
        [self.MemberlevelTableView setLayoutMargins:UIEdgeInsetsZero];
    }
    if ([self.onlineServiceTableView respondsToSelector:@selector(setSeparatorInset:)])
    {
        [self.onlineServiceTableView setSeparatorInset:UIEdgeInsetsZero];
    }
    if ([self.onlineServiceTableView respondsToSelector:@selector(setLayoutMargins:)])
    {
        [self.onlineServiceTableView setLayoutMargins:UIEdgeInsetsZero];
    }
    if ([self.offlineServiceTableView respondsToSelector:@selector(setSeparatorInset:)])
    {
        [self.offlineServiceTableView setSeparatorInset:UIEdgeInsetsZero];
    }
    if ([self.offlineServiceTableView respondsToSelector:@selector(setLayoutMargins:)])
    {
        [self.offlineServiceTableView setLayoutMargins:UIEdgeInsetsZero];
    }
...
-(void)viewWillLayoutSubviews{
    ...
    self.onlineServiceTableView.frame = self.MemberlevelTableView.frame;
    self.offlineServiceTableView.frame = self.MemberlevelTableView.frame;
}
