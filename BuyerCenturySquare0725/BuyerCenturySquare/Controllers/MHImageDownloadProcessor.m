...
@property (nonatomic, assign)NSInteger uploadedImageItems;
...
- (void)saveImagesUnderDirectory:(NSString*)directory {
    ...
    self.imageItems = imageFiles.count;

    self.uploadedImageItems = 0;
...
-(void)saveImages:(NSArray *)imageFiles {
    ...
    NSString * imageFile = copyImageFiles[0];
...
- (void)image: (UIImage *) image didFinishSavingWithError: (NSError *) error contextInfo: (void *) contextInfo {
    ...
    if(error != nil){
        ...
        /*
        self.uploadedImageItems++;
        if (self.uploadedImageItems >= self.imageItems) {
