...
- (void)awakeFromNib{
    ...
    self.feedBackTextView.layer.cornerRadius = 2;
//    self.wordLimitLabel.backgroundColor = [UIColor redColor];

    if ([self.feedBackTextView.text isEqualToString:@"您遇到什么问题，或者哪些功能建议，欢迎在此提出！我们将持续跟进优化。"]) {
        
        self.wordLimitLabel.text = @"0/200";
