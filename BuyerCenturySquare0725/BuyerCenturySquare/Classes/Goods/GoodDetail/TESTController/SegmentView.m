...
-(id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        _objectBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, Main_Screen_Width/3, 30)];
        ...
        [_reftBtn setTitleColor:[UIColor colorWithHexValue:0x999999 alpha:1] forState:UIControlStateNormal];
        ...
        _attrBtn = [[UIButton alloc] initWithFrame:CGRectMake(Main_Screen_Width*2/3, 0, Main_Screen_Width/3, 30)];
        [self addSubview:_attrBtn];
        [_attrBtn setTitle:@"规格参数" forState:UIControlStateNormal];
        [_attrBtn setTitleColor:[UIColor colorWithHexValue:0x999999 alpha:1] forState:UIControlStateNormal];
        _attrBtn.titleLabel.font = [UIFont systemFontOfSize:13];
        _attrBtn.backgroundColor = [UIColor colorWithHexValue:0x333333 alpha:1];
        [_attrBtn addTarget:_delegate action:@selector(attrImgBtnClicked:) forControlEvents:UIControlEventTouchUpInside];
    }
