...
@implementation CSPChangePasswordView
...
-(void)makeUI
{
    ...
    self.secretTextField.font = [UIFont fontWithName:@"systemFontOfSize:" size:13];
    ...
    self.repeatSecretTextField.font = [UIFont fontWithName:@"systemFontOfSize:" size:13];
