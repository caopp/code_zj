...
@interface KeyboardToolBarTextField()
...
@implementation KeyboardToolBarTextField
static KeyboardToolBarTextField *keyboardToolBar = nil;
+ (void)registerKeyboardToolBar:(UITextField *)textField {
    if([KeyboardToolBarTextField shareKeyboardToolBar].allRegisterTextFields == nil) {
...
+ (instancetype)shareKeyboardToolBar {
    if (keyboardToolBar == nil) {
        keyboardToolBar = [[KeyboardToolBarTextField alloc]initWithFrame:CGRectMake(0, 0, KeyboardToolBarWidth, KeyboardToolBarHeight)];
...
- (void)reSetTextField:(UITextField *)textField {
    UITextField *tempTextField = [keyboardToolBar.allRegisterTextFields objectForKey:[NSString stringWithFormat:@"%p",textField]];
    CGFloat textWidth = [KeyboardToolBarTextField widthForString:tempTextField.text withFont:keyboardToolBar.toolBarTextField.font];
