...
-(void)initializePickerViewInView: (UIView *)view
  ...
  UIImage * toolbarImage = options[MMtoolbarBackgroundImage];
    CGRect mainFrom = [UIScreen mainScreen].bounds;
  ...
  _pickerContainerView = [[UIView alloc] initWithFrame:CGRectMake(0.0, _pickerViewContainerView.bounds.size.height - 260.0, mainFrom.size.width, 260.0)];
