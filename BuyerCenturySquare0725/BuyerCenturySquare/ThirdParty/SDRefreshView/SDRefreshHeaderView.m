...
-(void)makeHeaderView{
    ...
    if (_headerView==nil) {
        ...
        for (int i=0; i<4; i++) {
            ...
            UIImageView *circleImageView=[[UIImageView alloc]initWithFrame:CGRectMake(XS+i*(WIDTHS+2), YS, WIDTHS, WIDTHS)];
        ...
        for (int i=0; i<2; i++) {
            ...
            UIImageView *lineImageView=[[UIImageView alloc]initWithFrame:CGRectMake((XS+WIDTHS-5)+i*(WIDTHS+2) - 2, -145 , 6, YS+150)];
        ...
        //底部的竖条
        UIImageView *lineImageThree=[[UIImageView alloc]initWithFrame:CGRectMake(XS+WIDTHS*3+2*3 + 1, YS+WIDTHS-4, 6, hight - CGRectGetMaxY(_circleImageFour.frame)+ 4)];
...
-(void)makeAni{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        _circleImageOne.center=CGPointMake(60, YS+WIDTHS/2);//去左边
        ...
        [UIView animateWithDuration:0.2 animations:^{//回到原来的位置+8 和第二个球碰撞
            ...
            _circleImageOne.frame=CGRectMake(XS+8, YS, WIDTHS, WIDTHS);
            ...
            [UIView animateWithDuration:0.08 animations:^{
                ...
                [UIView animateWithDuration:0.1 animations:^{
                    ...
                    //第一个球变回原来的位置
                    _circleImageOne.frame=CGRectMake(XS, YS, WIDTHS, WIDTHS);
            ...
            [UIView animateWithDuration:0.3 animations:^{
                ...
                //第四个球被撞击出去
                _circleImageFour.center=CGPointMake(BOUNDSWIDTH-60, YS+WIDTHS/2);
                ...
                [UIView animateWithDuration:0.2 animations:^{
                    ...
                    _circleImageFour.frame=CGRectMake(XS+WIDTHS*3+2*3-8, YS, WIDTHS, WIDTHS);
...
-(void)thrreWithFourMove{
    ...
    [UIView animateWithDuration:0.08 animations:^{
        ...
        [UIView animateWithDuration:0.1 animations:^{
            ...
            _circleImageFour.frame=CGRectMake(XS+3*WIDTHS+3*2, YS, WIDTHS, WIDTHS);
