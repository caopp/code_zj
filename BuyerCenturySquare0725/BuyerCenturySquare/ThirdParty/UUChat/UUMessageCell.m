...
- (void)setMessageFrame:(UUMessageFrame *)messageFrame{
    ...
    if (message.from == UUMessageFromMe) {
        ...
        [self.btnHeadImage sd_setImageWithURL:[NSURL URLWithString:[MemberInfoDTO sharedInstance].iconUrl] placeholderImage:[UIImage imageNamed:@"10_商品询单对话_个人"]];
    }else{
        
        [self.btnHeadImage sd_setImageWithURL:[NSURL URLWithString:message.strIcon] placeholderImage:[UIImage imageNamed:@"10_商品询单对话_客服"]];
    }
