...
- (void)show
{
    ...
    UIWindow *window = _showKeyWindow?[UIApplication sharedApplication].keyWindow: [AppDelegate currentAppDelegate].window;//;
...
- (void)createScrollView
{
    ...
    frame.origin.y -= (_showKeyWindow?44:0);
...
//    if (!_showKeyWindow) {
//        [[NSNotificationCenter defaultCenter] postNotificationName:kNextWindowShowAnimation object:nil];
//        
//    }else{
//       [[NSNotificationCenter defaultCenter] postNotificationName:kNextWindowFullAnimation object:nil];
//    }
//
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:@"ReloadPhoto" object:nil];
