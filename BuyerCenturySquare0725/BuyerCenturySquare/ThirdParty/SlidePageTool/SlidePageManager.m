...
- (UIScrollView*)setUpView{
    switch (self.slidePageType) {
        ...
        case SlidePageTypeLine:{
            self.slidePageLineView  = [[SlidePageLineView alloc]initWithDataArr:self.dataArr bgColor:_bgColor squareViewColor:_squareViewColor unSelectTitleColor:_unSelectTitleColor selectTitleColor:_selectTitleColor withTitleFont:_titleFont];
