...
@property (nonatomic, assign) id<STEmojiKeyBoardDelegate> delegate;
...
- (void)loadUI{
    ...
    sendButton.frame = CGRectMake(left+w, 0, w - 5, h - 5);
    sendButton.tag = 100;
    sendButton.backgroundColor = [UIColor colorWithRed:0.72 green:0.71 blue:0.9 alpha:1];
...
@interface STEmojiKeyboard () <STEmojiCollectionViewDelegate, STEmojiKeyBoardDelegate>
...
- (void)loadUI{
    ...
    __weak __typeof(_emojiPageView) wPageView = _emojiPageView;
    __weak __typeof(_toolBar) wToolBar = _toolBar;
