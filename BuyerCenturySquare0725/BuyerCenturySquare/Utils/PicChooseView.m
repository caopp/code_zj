...
- (void)addPic {
    ...
    UILabel * photoLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 63, 59, 13)];
    photoLabel.text = @"照片";
    ...
    UILabel * cameraLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 65, 59, 13)];
    cameraLabel.text = @"拍摄";
    ...
    if (_plusType == PlusType_Three) {
        ...
        [referralImageView setImage:[UIImage imageNamed:@"10_商品询单对话_添加拍照"]];
        [referralView addSubview:referralImageView];
        
        UILabel * referralLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 65, 59, 13)];
